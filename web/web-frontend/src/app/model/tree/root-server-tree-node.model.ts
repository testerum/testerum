...
import {FeatureServerTreeNode} from "./feature-server-tree-node.model";

export class RootServerTreeNode implements Serializable<RootServerTreeNode>, ServerContainerTreeNode {
    name: string;
    path: Path;
