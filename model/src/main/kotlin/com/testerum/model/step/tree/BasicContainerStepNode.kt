...
data class BasicContainerStepNode @JsonCreator constructor(@JsonProperty("path") override val path: Path,
                                                           @JsonProperty("name") val name: String) : BasicStepNode, ContainerTreeNode {

    @JsonProperty("children") val children: MutableList<BasicStepNode> = mutableListOf()
    ...
    override fun addChild(child: TreeNode) {
        val childAsBasicStepNode = child as? BasicStepNode
