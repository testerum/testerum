...
class WebDriverManager(private val testContext: TestContext) {
    ...
    fun executeWebDriverStep(block: (WebDriver) -> Unit) {
        ...
        // take screenshot
        if (testContext.settingsManager.getSettingValueOrDefault(SETTING_KEY_TAKE_SCREENSHOT_AFTER_EACH_STEP)!!.toBoolean()) {
        ...
        TimeUnit.MILLISECONDS.sleep(
                testContext.settingsManager.getSettingValueOrDefault(SETTING_KEY_AFTER_STEP_DELAY_MILLIS)!!.toLong()
        )
    }
