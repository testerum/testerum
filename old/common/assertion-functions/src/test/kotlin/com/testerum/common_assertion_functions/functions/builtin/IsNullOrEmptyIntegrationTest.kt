...
class IsNullOrEmptyIntegrationTest : BaseBuiltinFunctionIntegrationTest() {

    @Test
    fun `should not throw exception for null node`() {
        functionEvaluator.evaluate("@isNullOrEmpty()", NullNode.getInstance())
    }

    @Test
    fun `should throw exception for boolean false node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", booleanNode(false))
        }
    }
    ...
    fun `should throw exception for boolean true node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", booleanNode(true))
        }
    }

    @Test
    fun `should not throw exception for empty text node`() {
        functionEvaluator.evaluate("@isNullOrEmpty()", textNode(""))
    }
    ...
    fun `should throw exception for non-blank text node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", textNode("some text"))
        }
    }
    ...
    fun `should throw exception for short numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", shortNode(13))
        }
    }
    ...
    fun `should throw exception for int numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", intNode(13))
        }
    }
    ...
    fun `should throw exception for long numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", longNode(13))
        }
    }
    ...
    fun `should throw exception for big integer numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", bigIntegerNode(BigInteger("13")))
        }
    }
    ...
    fun `should throw exception for float numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", floatNode(13.5f))
        }
    }
    ...
    fun `should throw exception for double numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", doubleNode(13.5))
        }
    }
    ...
    fun `should throw exception for decimal numeric node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", decimalNode(BigDecimal("13.5")))
        }
    }
    ...
    fun `should throw exception for empty array node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", arrayNode())
        }
    }
    ...
    fun `should throw exception for empty object node`() {
        Assertions.assertThrows(AssertionFailedException::class.java) {
            functionEvaluator.evaluate("@isNullOrEmpty()", objectNode())
        }
    }
