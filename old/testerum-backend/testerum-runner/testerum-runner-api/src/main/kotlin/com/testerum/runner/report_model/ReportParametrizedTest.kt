...
data class ReportParametrizedTest(@JsonProperty("testName")         val testName: String,
                                  ...
                                  @JsonProperty("children")         val children: List<ReportScenario>) : FeatureOrTestRunnerReportNode
