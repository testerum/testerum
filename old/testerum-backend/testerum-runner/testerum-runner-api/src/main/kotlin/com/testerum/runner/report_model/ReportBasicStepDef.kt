...
data class ReportBasicStepDef @JsonCreator constructor(@JsonProperty("id")          override val id: String,
                                                       ...
                                                       @JsonProperty("methodName")  val methodName: String) : ReportStepDef
