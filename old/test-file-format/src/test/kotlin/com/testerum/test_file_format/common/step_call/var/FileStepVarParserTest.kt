...
class FileStepVarParserTest {
    ...
    fun `should parse empty value`() {
        assertThat(parser.parse("var name = <<>>"))
            .isEqualTo(
    ...
    fun `should parse single-line description`() {
        assertThat(parser.parse("var varName = <<some variable value>>"))
            .isEqualTo(
    ...
    fun `escaping - should parse single-line, backslash`() {
        assertThat(parser.parse("""var varName = <<2 \ 1>>"""))
            .isEqualTo(
                FileStepVar(
                    name = "varName",
                    value = """2 \ 1"""
    ...
    fun `escaping - should parse single-line with multiple escapes`() {
        assertThat(parser.parse("""var varName = <<5000 \>> 200 \>> 1>>"""))
            .isEqualTo(
                FileStepVar(
                    name = "varName",
                    value = "5000 >> 200 >> 1"
